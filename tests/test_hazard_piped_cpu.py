...
async def test_cpu_top(dut):
    ...
    dut._log.info(f"x5 = {x5} x6 = {x6} x7 = {x7} x8 = {x8} x9 = {x9}")

    assert x5 == 5, f"x5 = {x5}, expected 5"
    assert x6 == 6, f"x6 = {x6}, expected 6"
    assert x7 == 7, f"x7 = {x7}, expected 7"
    assert x8 == 8, f"x8 = {x8}, expected 8"
    assert x9 == 9, f"x9 = {x9}, expected 9"

    dut._log.info("CPU hazard tests passed")
